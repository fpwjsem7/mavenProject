...
#roadviewControl {position:absolute;top:10px;left:325px;width:42px;height:42px;z-index: 1;cursor: pointer; background: url(https://t1.daumcdn.net/localimg/localimages/07/2018/pc/common/img_search.png) 0 -450px no-repeat;}
...
<div class="map_wrap">
    ...
    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <div>
                <form onsubmit="keyWordSearchPlaces(); return false;">
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9a79eb05a8f820e58433261ebf91958e&libraries=services"></script>
<script>
...
//이 예제에서는 지도 타입을 추가할 때 지적편집도, 지형정보, 교통정보, 자전거도로 정보순으로 추가하므로
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
	mapCenter = new kakao.maps.LatLng(37.566826, 126.9786567), // 지도의 중심좌표
    mapOption = {
        center: mapCenter,
        level: 3 // 지도의 확대 레벨
    };  
...
function displayPlaces(places) {
	...
	if (!currCategory) {
	    ...
	    for ( var i=0; i<places.length; i++ ) {
	            ...
	            // 마커를 생성하고 지도에 표시합니다
	            var marker = addMarker(new kakao.maps.LatLng(places[i].y, places[i].x), null, null, order);
...
function addMarker(position, idx, title, order) {
...
function closeRoadview() {
	console.log("closeRoadview event");
    var position = marker.getPosition();
    toggleMapWrapper(true, position);
}
</script>
